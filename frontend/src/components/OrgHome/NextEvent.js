                ...
                <Box sx={{ display: 'flex', alignItems: 'center', pl: 1 }}>
                  ...
                  <div className="card-title"><strong>{truncateText(nextEvent.name, 25)}</strong></div>
                    ...
                    <Grid container justifyContent='flex-end' style={{ marginBottom: '0' }}>
						<Button disabled={!generateCheckIn} sx={{ mt: 2, mr: 1, width: 165, borderRadius: 8, backgroundColor: "#5f5395", "&:hover": {backgroundColor: "#7566b4"}}} variant="contained" onClick={() => {setCheckType("In"); setOpenQRModal(true);}}>Generate Check-In Code</Button>
						<Button disabled={!generateCheckOut} sx={{ mt: 2, width: 165, borderRadius: 8, backgroundColor: "#5f5395", "&:hover": {backgroundColor: "#7566b4"}}} variant="contained" onClick={() => {setCheckType("Out"); setOpenQRModal(true);}}>Generate Check-Out Code</Button>
                      </Grid>
                  </CardContent>
                </Box>
            </Card>
