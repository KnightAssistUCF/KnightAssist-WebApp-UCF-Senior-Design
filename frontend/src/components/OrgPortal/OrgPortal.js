    ...
    return(
      <div>
        ...
        <div className='move'>
          ...
          <AddEventModal setReset={setResetUpcoming} reset={resetUpcoming} open={openModal} setOpen={setOpenModal} editMode={editMode} setEditMode={setEditMode} eventID={eventID}/>
